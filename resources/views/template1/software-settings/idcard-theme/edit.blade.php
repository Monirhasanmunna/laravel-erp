    ...
    <div class="main-panel">
        ...
        <div class="card new-table">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4 style="color:rgba(0, 0, 0, 0.5)">ID Card List</h4>
                <a href="{{route('software-settings.idcardtheme.create')}}" class="btn btn-sm btn-primary "><i class="fa-solid fa-circle-plus"></i>Add Id Card</a>
            </div>
            <div class="card-body">
                <div class="row">
