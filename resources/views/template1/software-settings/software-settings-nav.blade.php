    ...
    <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navigation">
            <ul class="navbar-nav navbar-nav-hover mr-auto">
                ...
                <li class="nav-item">
                    <a href="{{route('software-settings.recycle-bin.index')}}" class="nav-link pages" id="nav-hov" >
                        Recycle Bin
                    </a>
                </li>

                <li class="nav-item {{Request::is('software-settings/import-data/*')?'custom_nav':''}}">
                    <a href="{{route('software-settings.import-data.index')}}" class="nav-link pages" id="nav-hov" >
                        Import Data
                    </a>
                </li>
