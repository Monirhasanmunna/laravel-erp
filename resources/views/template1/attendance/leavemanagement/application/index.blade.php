                    ...
                    <table id="customTable" class="table table-striped table-responsive" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{Str::limit(@$template->application,100)}}</td>
                                <td class="text-center">
                                    <a class=" btn-sm btn-primary " href="{{route('attendance.leavetemplate.edit',@$template->id)}}"><i class="fa-solid fa-pen-to-square"></i></a>
                                    <a class=" btn-sm btn-danger " href="{{route('attendance.leavetemplate.destroy',@$template->id)}}"><i class="fa-solid fa-trash"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
