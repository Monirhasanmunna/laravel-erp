        ...
        $.ajax({
            ...
            success : function(data){
                ...
                var html = `<tr>
                                ...
                                <td>${data.student.ins_class.name} - ${data.student.section ? data.student.section.name : ''} - ${data.student.group ? data.student.group.name : ''}</td>
                ...
                var btn = `<a class="btn btn-primary float-right" href='/attendance/student-application/update/approve/${data.application.id}'>Approve</a>
                           <a class="btn btn-danger" float-right href='/attendance/student-application/update/reject/${data.application.id}'>Reject</a>`;
