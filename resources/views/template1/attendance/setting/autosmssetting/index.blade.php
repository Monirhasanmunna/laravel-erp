        ...
        <div class="card new-table">
            <div class="card-body">
                ...
                <div class="content-wrapper text-primary">
                    ...
                    <form class="" id="autoSmsSend-form" method="GET">
                        <div class="row mt-2">
                            <div class="col-3">
                                <h5 class="p-2 text-white" style="background-color: #04726f">Teacher Api Sms Time</h5>
                            </div>

                            <div class="col-7">
                                <div class="input-group mb-2">
                                    <input type="time" class="form-control" id="inlineFormInputGroup" value="{{@$teacherapisms->sms_send_time}}" name="sms_send_time">
                                </div>
                            </div>
                    ...
                    <form class="" id="autoSmsSendStudent-form" method="GET">
                        <div class="row mt-2">
                            <div class="col-3">
                                <h5 class="p-2 text-white" style="background-color: #04726f">Student Api Sms Time</h5>
                            </div>

                            <div class="col-7">
                                <div class="input-group mb-2">
                                    <input type="time" class="form-control" id="inlineFormInputGroup" value="{{@$studntapisms->sms_send_time}}" name="sms_send_time">
                                </div>
                            </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $("#autoSmsSend-form").submit(function(e){
            e.preventDefault();
            var form = $(this);
            var url  = "{{route('attendance.autosmssetting.teacher-api-sms')}}";
        ...
        $("#autoSmsSendStudent-form").submit(function(e){
            e.preventDefault();
            var form = $(this);
            var url  = "{{route('attendance.autosmssetting.student-api-sms')}}";
