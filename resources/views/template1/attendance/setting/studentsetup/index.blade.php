        ...
        <div class="card new-table">
            <div class="card-body">
                ...
                <form id="student-form" method="GET">
                    @include('custom-blade.search-student-setup')
                </form>
            </div>
            </div>
                                ...
                                html += '<tr>'
                                    ...
                                    html += `<td style="width:80px">
                                                <div class="img-select text-center">
                                                    <img class="rounded-circle img-fluid" style="width:40px;height:40px;border-radius:50%;border:1px solid #aeacac;padding:3px;" src="{{Config::get('app.s3_url')}}${v.photo == null? 'male.png':v.photo}" id="image-preview-${v.id}">
                                                </div>
                                            </td>`
                                    ...
                                    html += `<td>
                                                <input type="number" class="form-control" name="" value="${v.device_id != 0 ? v.device_id : deviceId}">
                                                <input type="hidden" class="form-control" name="device_id" value="${deviceId}">
                                            </td>`

                                    html += `<td>
                                                <input type="number" class="form-control" name="finger_id[${v.id}]" id="finger_id" value="${v.finger_id}">
                                            </td>`
