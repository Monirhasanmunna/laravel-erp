            ...
            $('#teachersetup-form').submit(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        let html = '';
                        html += `<input type="hidden" class="form-control" name="type" value="${data.data.teacher_id}">`;
                        if (data.teachers.length > 0) {
                            $.each(data.teachers, function(i, value){
                                html += `<tr>
                                            ...
                                            <td><input type="text" disabled class="form-control" name="designation[${value.id}]" id="designation" value="${value.designation ? value.designation.title : 'Teacher'}"></td>
                                            ...
                                            <td>
                                                <input type="number" class="form-control" name="" value="${value.device_id != 0 ? value.device_id : deviceId}">
