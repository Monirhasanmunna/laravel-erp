...
<div class="card new-table mb-3">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h4 style="color:rgba(0, 0, 0, 0.5)">Import Number</h4>
            <a href="{{route('sms.contact.index')}}" class="btn btn-sm btn-primary "><i class="fa-solid fa-arrow-left"></i>Back</a>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <form action="{{route('sms.contact.excel-import-list')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <a href="{{asset('sms-Numbers.xlsx')}}" target="_new"
