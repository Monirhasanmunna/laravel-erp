...
<div class="main-panel" id="school-info-id">
    ...
    <div class="card new-table">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{isset($info)? route('info.update',$info->id): route('info.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="name2" id="name2" value="{{$info->name2 ?? ''??@old('name2')}}">
                                @if($errors->has('name2'))
                            <div class="error">{{ $errors->first('name2') }}</div>
                            @endif
                            </div>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6 mt-2">
                            ...
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label" for="customFile">Choose School Photo</label>
                                @if($errors->has('school_photo'))
                            <div class="error">{{ $errors->first('school_photo') }}</div>
                            @endif
                            </div>
                            <img class="mt-2" id="school_photo" src="{{@$info->logo === 'default.png' ? Helper::default_image() : Config::get('app.s3_url').@$info->school_photo}}"
                        ...
                        <div class="col-sm-6 mt-2">
                            ...
                            <img class="mt-2" id="favicon" src="{{@$info->logo === 'default.png' ? Helper::default_image() : Config::get('app.s3_url').@$info->favicon}}"
                        ...
                        <div class="col-sm-6">
                            ...
                            <img class="mt-2" id="logo" src="{{@$info->logo === 'default.png' ? Helper::default_image() : Config::get('app.s3_url').@$info->logo}}"
                                alt="logo" width="100" height="100"/>
                        </div>
