    ...
    <div class="main-panel">
        ...
        <div class="card new-table">
            <div class="card-header">
                <h6>Setting Edit <code>({{Auth::user()->branch_name}})</code></h6>
            </div>
            <div class="card-body">
                
                <form action="{{isset($setting)? route('academic.setting.update',$setting->id): route('academic.setting.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="mb-3">
                                <label for="testimonial_content" class="form-label">Testimonial Content <small class="text-danger"> Use this short code carefully :name, :father_name, :mother_name , :division , :district , :upazila , :class, :roll, :session, :result, :group, :birth_date, :board_name</small></label>
                                <textarea class="form-control" id="testimonial_content" name="testimonial_content"
                                    rows="10" class="@error('testimonial_content') is-invalid @enderror">{{@$setting->testimonial_content}}</textarea>
