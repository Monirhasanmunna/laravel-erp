...
<table style="margin-top: 20px; margin-left: 5px; text-transform: uppercase; width:200px; height:90px; line-height: 10px;">
<tr>
    <td style="font-size:10px;text-transform: capitalize; font-weight: 400;padding: 0px 19px;">Roll</td>
    <td style="font-size:10px;text-transform: capitalize; font-weight: 400;"> : {{@$student->roll_no}}</td>
</tr>
<tr>
    @php
