        ...
        <div>
            <div class="card new-table" id="table-card" style="display: none">
                <div class="card-body">
                    ...
                    <a href="javascript:void(0)" id="downloadBtn" class="btn-sm btn-primary text-white float-right mr-1 mb-2 mt-2 d-none"><i class="fa-solid fa-cloud-arrow-down pr-1"></i>Front</a>
                    <a href="javascript:void(0)" id="downloadBtnBack" class="btn-sm btn-primary text-white float-right mr-1 mb-2 mt-2 d-none"><i class="fa-solid fa-cloud-arrow-down pr-1"></i>Back</a>

                    <div class="">
                    <form action="{{route('academic.id-card.alldownload')}}" id="download-form" method="post">
                        @csrf
            ...
            $('#student-form').submit(function(e){
                ...
                if(section){
                    ...
                    success: (data) => {
                        ...
                        $("#idcard-download-form").empty();
                        $("#idcard-backdownload-form").empty();
                        ...
                        $.each(data.students,function(i,v){
                           // let viewBtn = `<a class="btn btn-info" href="/academic/id-card/view/${v.id}"><i class="fa fa-eye"></i></a>`;
                            let dwnBtn = `<a class="btn-sm btn-primary" href="/academic/id-card/download-card/${v.id}"><i class="fa fa-arrow-down"></i></a>`;
                            let value = `<input type="number" name="student_id[]" hidden value='${v.id}'>`;
                                ...
                                html += `<tr>
                                            <td scope="col" class='text-center'>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input exampleCheck" checked name="check[]" id="exampleCheck" value="${v.id}">
                                                </div>
                                            </td>
                                            <td>
                                                ${v.id_no}
                                            ...
                                            <td class='text-center'>${dwnBtn}</td>
                                        </tr>`;
                            }else{
                                html += `<tr>
                        ...
                        $("#idcard-download-form").html(html);
                        $('tbody').html(html);
