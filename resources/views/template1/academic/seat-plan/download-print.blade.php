...
<body>
                          ...
                          <tr>
                             ...
                             ">
                                      ...
                                      <tr>
                                          ...
                                          <td style="font-size:12px;">&#160;&#160;:&#160;&#160;&#160;</td>
                                          <td style="font-size:12px;">{{@$student->class->name}}{{@$student->shift->name != 'N/A' ? '-'.@$student->shift->name : ''}}{{@$student->section->name != 'N/A' ? '-'.@$student->section->name : ''}}{{@$student->category->name != 'N/A' ? '-'.@$student->category->name : ''}}
                                          </td>
                                      </tr>
                                      <tr>
    ...
    @endforeach
    @else
    <div style="width:395px;height:auto;float:left;">
        <table style="width: 100%;">
            <td style="position: relative;">
              <img src="{{@Helper::academic_setting()->image ? Config::get('app.s3_url').Helper::academic_setting()->image : asset('logo.jpg')}}" style="position: absolute; top: 14px; left: 20px; width: 50px; height: 50px;">
              <!-- Your table content goes here -->
