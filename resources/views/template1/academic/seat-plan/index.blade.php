        ...
        <div class="card new-table">
            <div class="card-body">
                ...
                <form id="student-form" method="GET">
                    @include('custom-blade.seat-plan-search')
                </form>
            </div>
        </div>
        ...
        <div>
            <div class="card new-table" id="table-card" style="display: none">
                <div class="card-body">
                    ...
                    <a href="javascript:void(0)" id="downloadBtn" class="btn btn-primary text-white float-right mr-1 mb-2 mt-2 d-none"><i class="fa-solid fa-file-pdf"></i>Print</a>
                ...
                if(section){
                    ...
                    success: (data) => {
                        ...
                        $.each(data.students,function(i,v){
                            ...
                            let viewBtn = `<a class="btn-sm btn-info" target="_blank" href="/academic/seat-plan/view/${v.id}/${exam_id}"><i class="fa fa-eye"></i></a>`;
                            let dwnBtn = `<a class="btn-sm btn-primary" href="/academic/seat-plan/download-card/${v.id}/${exam_id}"><i class="fa fa-arrow-down"></i></a>`;
                            ...
                            if(v){
                                html += `<tr>
                                            ...
                                            <td width='10%' class='text-center'>${viewBtn}  ${dwnBtn}</td>
                                        </tr>`;
                            }else{
                                html += `<tr>
