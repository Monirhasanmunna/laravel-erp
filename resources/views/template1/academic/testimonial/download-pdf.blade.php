...
<body>
  @if (isset($students))
    ...
    <div style="width:100%;border: 20px solid #1c6077; padding:4px; margin-top:10px;" class="template">
                ...
                <table style="padding-bottom: 30px;width:100%">
                    <tr>
                        ...
                        padding-top: 3px; text-transform: capitalize; text-align:center;">Office Assistant</td>
                                ...
                                <tr>
                                    <td style="font-size: 18px; text-align:center;">Date: {{date('Y-m-d')}}</td>
                                </tr>
                            </table>
                        </td>
                        <td style="width: 30%; text-align: center;">
    ...
    @else 
    <div style="width:100%;border: 20px solid #1c6077; padding:4px; margin-top:10px;">
        <div style=" border: 2px solid #1c6077; padding: 1px;">
            <div style=" border: 2px solid #1c6077; padding: 10px 20px;">
                <table style="width: 100%;">
                    <tr>
                            ...
                            <table style="width: 80%;">
                                <tr>
                                    <td style="text-align:center;">
                                        {{-- <img style="height: 100px; padding-top:30px;"
