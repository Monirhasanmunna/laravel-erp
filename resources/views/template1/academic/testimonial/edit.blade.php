...
<html lang="en">
  ...
  <body>
    <div style="width: 80%; margin: auto; padding: 40px;">
      <form action="{{route('academic.testimonial.update',$testimonial->id)}}" method="post">
        @method('PUT')
        @csrf
      <div
        style="
      ...
      >
        ...
        >
          ...
          >
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3">
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('father_name') is-invalid @enderror" id="father_name" name="father_name" value="{{@$testimonial->father_name}}">
                      </div>
                  </div>
                  <div class="col-lg-3">
                      <div class="form-group">
                          <label for="mother_name">Mother's Name</label><br>
                          <input type="text" class="form-control @error('mother_name') is-invalid @enderror" id="mother_name" name="mother_name" value="{{@$testimonial->mother_name}}">
                      </div>
                  </div>
                  ...
                  <div class="col-lg-3">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('registration_no') is-invalid @enderror" name="registration_no" id="registration_no" value="{{@$testimonial->registration_no}}">
                    </div>
                  </div>
                  ...
                  <div class="col-lg-3 pt-2">
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('roll') is-invalid @enderror" name="roll" id="roll_no" value="{{@$testimonial->roll}}">
                      </div>
                  </div>
                      ...
                      <div class="form-group">
                          ...
                          <select class="form-control @error('division_id') is-invalid @enderror" name="division_id" id="division_id">
                              ...
                              <option value="{{ $division->id }}"
                                  {{$division->id == @$testimonial->division_id ? 'selected' : ''}}>
                      ...
                      <div class="form-group">
                          ...
                          <select class="form-control @error('district_id') is-invalid @enderror" name="district_id" id="district_id">
                              ...
                              <option value="{{ $district->id }}"
                                  {{$district->id == @$testimonial->district_id ? 'selected' : ''}}>
                      ...
                      <div class="form-group">
                          ...
                          <select class="form-control @error('upazila_id') is-invalid @enderror" name="upazila_id" id="upazila_id">
                              ...
                              <option value="{{ $upazila->id }}"
                                  {{$upazila->id == $testimonial->upazila_id ? 'selected' : ''}}>
                      ...
                      <div class="form-group">
                          ...
                          <select class="form-control @error('session_id') is-invalid @enderror" name="session_id" id="session">
                              ...
                              <option value="{{ $session->id }}"
                                  {{$session->id == $testimonial->session_id ? 'selected' : ''}}>
                      ...
                      <div class="form-group">
                          ...
                          <select class="form-control @error('class_id') is-invalid @enderror" name="class_id" id="class_id">
                              ...
                              <option value="{{ $class->id }}"
                                  {{$class->id == $testimonial->class_id ? 'selected' : ''}}>
                                  {{ $class->name }}</option>
                              @endforeach
                          </select>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <select class="form-control @error('semister_id') is-invalid @enderror" name="semister_id" id="semister_id">
                              ...
                              <option value="{{ $semester->id }}"
                                {{$semester->id == $testimonial->semister_id ? 'selected' : ''}}>
                  ...
                  <div class="col-lg-3 pt-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('board_name') is-invalid @enderror" name="board_name" id="board_name" value="{{@$testimonial->board}}">
                    </div>
                  </div>
                  ...
                  <div class="col-lg-3 pt-2">
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('result') is-invalid @enderror" name="result" id="result" value="{{@$testimonial->result}}">
                      </div>
                  </div>
            ...
            <input type="hidden" name="serial_no" value="{{$testimonial->serial_no}}">
