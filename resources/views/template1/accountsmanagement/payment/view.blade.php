        ...
        <div class="card new-table">
            ...
            <div class="card-body">
                <div class="float-right">
                    <a href="{{route('payment.view-invoice',[$student->id,$month])}}" class="btn btn-warning "><i class="fa fa-list"></i>Invoice List</a>
                    <a href="{{route('payment.view-invoice',[$student->id,$month])}}" class="btn btn-info "><i class="fa fa-history"></i>Invoice History</a>
                </div>

                <form action="{{route('payment.store')}}" method="POST" onsubmit="return submitForm(this);">
                    @csrf
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            function getPaymentsData(fees_type){
                ...
                let month      = "{{$month}}";
                let url        = "{{route('payment.get-student-payment-list')}}";
