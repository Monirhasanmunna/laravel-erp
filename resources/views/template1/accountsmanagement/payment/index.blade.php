...
<script>
    $(document).ready(function () {
        ...
        function searchQuery(){
            ...
            $('#search-query').html(`<b>Session:</b>${session}, <b>Class:</b>${section}, <b>Category:</b>${category}, <b>Group:</b>${group}, <b>Month:</b>${month}`);
        }
        ...
        $('#payment-form').submit(function (e) {
            ...
            e.preventDefault();
            let form = $(this);
            let link = "{{route('payment.get-student-payments-by-month')}}";
            searchQuery();
            $.ajax({
                url: link,
                type: "GET",
                ...
                success:function (data){
                    ...
                    $.each(data,function (idx,val){
                       ...
                       let btnLink = "/accountsmanagement/payment/view-payments/"+ val.id + '/' + val.month;
                       let invBtnLink = "/accountsmanagement/payment/view-invoice/"+ val.id + '/' + val.month;
