    ...
    <div class="main-panel">
        ...
        <div class="card new-table">
            <div class="card-header">
                ...
                <a href="{{route('payment.view-payments',[$student->id,$month])}}" class="btn btn-dark"><i class="fa fa-arrow-left"></i>Back</a>
            </div>
                    ...
                    <tbody>
                        @foreach($studentPayments as $payment)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('payment.download-invoice',$payment->id)}}" class="btn btn-success"><i class="fa fa-download"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
