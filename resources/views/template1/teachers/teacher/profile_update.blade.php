    ...
    <div class="main-panel" id="update-profile-id">
        ...
        <div class="card new-table">
            <div class="card-body">
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="religion" class="form-select form-control">
                                                        ...
                                                        @foreach ($religions as $r)
                                                            <option value="{{ $r->name }}" {{ $teacher->religion == $r->name ? 'selected' : '' }}>{{ $r->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="number" name="unique_id"
                ...
                <form id="deleteForm" style="display:none;" action="{{route('teacher.destroy',$teacher->id)}}" method="post">
                    @method('PUT')
                    @csrf
                </form>
            </div>
        ...
        $(document).ready(function() {
            ...
            $('#cng-password').click(function(e){
                ...
                if(password != cpassword){
                    ...
                    $('#match-error').html('');
                    $.post("{{route('teacher.change-password')}}",{teacher_id,password},
                    function(data){
                        console.log(data);
                        if (data.status == '200') {
                                Toast.fire({
