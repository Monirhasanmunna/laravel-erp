                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-responsive" style="width:100%; padding:10px">
                            <thead>
                                <tr>
                                    <td style="width:30%" class="px-2">Name</td>
                                    <td style="width:30%" class="px-2">Email</td>
                                    <td style="width:30%" class="px-2">Phone</td>
                                    <td style="width:30%" class="px-2">Date Of Birth</td>
                                </tr>
                            </thead>
                            <tbody>
                                @if ($teachers->count())
                                    ...
                                    <tr>
                                        <td style="width:30%" class="px-2">{{$t->name}}</td>
                                        <td style="width:30%" class="px-2">{{$t->email}}</td>
                                        <td style="width:30%" class="px-2">{{$t->mobile_number}}</td>
                                        <td style="width:30%" class="px-2">{{$t->date_of_birth}}</td>
                                    </tr>
