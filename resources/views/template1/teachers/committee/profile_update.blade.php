        ...
        <div class="card new-table">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <form action="{{ route('committee.update', @$teacher->id) }}" method="POST">
                            @csrf
                            <input type="hidden" name="id" value="{{ $teacher->id }}">
                            <div class="card mb-3">
                                <div class="card-body">
                                                    ...
                                                    <select class="form-control" name="branch" id="">
                                                        ...
                                                        @foreach ($branches as $branch)
                                                            <option value="{{ $branch->id }}"
                                                                {{ @$teacher->branch_id === $branch->id ? 'selected' : '' }}>
                                                                {{ $branch->title }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                ...
                <div class="row mt-2">
                    <div class="col-md-12">
                        <div class="card mt-2">
                            <div class="card-body " id="exp-body" style="padding-top: 12px; padding-bottom: 19px;">
                                <div>
                                    ...
                                    <a href="" id="delete-exp"
                                            class="btn btn-danger float-right delete-exp mr-2"><i class="fa-solid fa-square-xmark"></i></a>
                                </div>
                                <hr class="exp-hr">
                                ...
                                <div class="exp-div">
                                    @forelse (@$teacher->experiences as $experience)
                                        <div class="card" style="box-shadow: none;border:1px solid rgb(209, 209, 209)" id="exp-card">
                                            <div class="card-body">
                                                <div id="exp-div" style='border:none; padding:0px;margin-top:0px;'>
                                                    <div class="form-row">
                                                        <div class="col">
                                    ...
                                    @empty
                                        <div class="card" style="box-shadow: none;border:1px solid rgb(209, 209, 209)" id="exp-card">
                                            ...
                                            <div class="card-body pt-0 pb-0">
                                                <div id="exp-div" style='border:none;margin-top:0px;'>
                                                    <div class="form-row">
                                                        <div class="col">
                                                            <label for="">Org.</label>
                                                            <input type="text" class="form-control" name="org_name[]"
                ...
                <div class="row mt-3">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body" id="qual-body" style="padding-top: 12px; padding-bottom: 19px;">
                                <div>
                                    <p class="mb-2 float-left"><b> Qualification</b></p>
                                    <a href="" id="qual-add" class="btn btn-primary float-right mb-2"> <i
                                            class="fa fa-plus"></i></a>
                                    <a href="" id="delete-qual" class="btn btn-danger float-right delete-qual mr-2 "><i class="fa-solid fa-square-xmark"></i></a>
                                </div>
                                <hr class="qual-hr">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group mt-3">
                            <button type="submit" class="btn btn-primary float-right"><i class="fa fa-arrow-alt-circle-up"></i> Update</button>
                            @if ($teacher->attendance == '')
                                <a href="javascript:void(0)" onclick="deleteBtn()" class="btn btn-danger"><i class="fa-solid fa-trash"></i> Delete</a>
                            @endif
                        </div>
                    </div>
                </div>
                ...
                <form id="deleteForm" style="display:none;" action="{{route('committee.destroy',$teacher->id)}}" method="post">
                    @method('PUT')
                    @csrf
                </form>
            </div>
...
<script>
    ...
    <script>
        ...
        $('#change_password_form').submit(function(e){
            ...
            var form = $(this);
            var url  = "{{route('teacher.change-password')}}";
        ...
        $(document).ready(function() {
            ...
            $('#signatureInput').change(function() {
             ...
             $('#signature-upload').submit(function(e) {
                e.preventDefault();
                var url = "{{ route('committee.updateSignature', $teacher->id) }}";
             ...
             $('#image-upload').submit(function(e) {
                e.preventDefault();
                var url = "{{ route('committee.updatephoto', $teacher->id) }}";
            ...
            $("#save").click(function(e) {
                e.preventDefault();
                var id = $('#id').val();
                var url = "{{ route('committee.update', $teacher->id) }}";
            ...
            $(document).on('click', '.delete-exp', function(e) {
                ...
                $this.closest('#exp-body').find('#exp-card').remove();
            });
            ...
            $this.closest('#qual-body').find('#qaual-card').remove();
            });
