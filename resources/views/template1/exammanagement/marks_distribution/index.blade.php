        ...
        <div>
            <div class="card new-table">
                <div class="card-header">
                    ...
                    <a href="{{ route('exam-management.setting.marks-dist.create') }}" class="btn btn-primary"><i class="fa fa-arrow-up"></i>Setup Mark Dist</a>
                </div>
                <div class="card-body">
                        ...
                        <div class="form-row mt-3">
                            ...
                            <div class="col">
                                <button type="submit" class="btn btn-primary" style="margin-top: 35px" >
                                    <i class="fa fa-arrow-circle-right" ></i> Process
                                </button>
                            </div>
                        </div>
                    ...
                    <table class="table table-bordered d-none mt-4" id="mark-dist-table">
                        <thead>
                            <tr>
                                <th>SL</th>
                    ...
                    success: (data) => {
                        ...
                        if (data.length > 0) {
                            $.each(data, function(i, v) {
                                ...
                                let btn =
                                    '<a href="{{ route('exam-management.setting.marks-dist.edit', 100) }}" class="btn btn-info"><i class=" fa fa-edit"></i> </a>';
                                let editBtn = btn.replace(100, v.id);

                                v.details.map(function(item) {
                                    trow += `<tr style="background-color: #efef!important">
                                               <td>
                                                   <p class="text-primary">${item.sub_mark_dist_type.title}</p>
                                               </td>
                                               <td>
                                                   ${item.mark}
                                               </td>
                                ...
                                html += `  <tr>
                                            ...
                                            <td>
                                                ${v.class_subject.subject.sub_name}
                                            </td>
                                            <td>
                                                ${v.total_mark}
                                            </td>
