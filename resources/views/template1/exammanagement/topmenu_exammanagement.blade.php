    ...
    <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navigation">
            <ul class="navbar-nav navbar-nav-hover mr-auto">
                ...
                <li class="nav-item {{Request::is('exam-management/number-sheet/index') ? 'active':''}}" id="exam_report">
                    <a class="nav-link nav-hov" href="{{route('exam-management.number-sheet.index')}}" id="nav-hov" >
                        Number Sheet
                    </a>
                </li>
    ...
    <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navigation">
            <ul class="navbar-nav navbar-nav-hover ml-auto">
                ...
                <li class="nav-item {{Request::is('exam-management/setting/combind-subject*') ? 'active':''}}">
                    <a class="nav-link" href="{{ route('exam-management.setting.combind-subject.index') }}" id="nav-hov">Combind Subject</a>
                </li>
                ...
                <li class="nav-item {{Request::is('exam-management/exam-setup/*') ? 'active':''}}">
                    <a class="nav-link" href="{{ route('exam-management.exam-setup.index') }}" id="nav-hov">
                        Exam Setup
                    </a>
                </li>
            </ul>
