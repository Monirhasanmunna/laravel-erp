                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h4 class="card-title" style="color:rgba(0, 0, 0, 0.5)"> Input Marks</h4>
                            </div>
                            <a href="{{route('exam-management.marks.create')}}" class="btn btn-primary mr-2" style="width: 175px;height: 34px;">Add New Marks</a>
                        </div>
