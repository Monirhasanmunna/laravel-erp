            ...
            <div class="card new-table">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('exam-management.marks.index') }}" class="btn btn-dark"><i
                    ...
                    <div class="card-body">
                        ...
                        <a href="" target="_blank" id="print" class="btn btn-success float-right ml-2 d-none" type="submit"><i
                                    class="fa fa-print"></i>Print</a>
                    

                        <a id="up-excel" href="{{ route('exam-management.marks.upload-excel') }}" class="btn btn-dark float-right mb-2 ml-2 d-none" ><i class="fa fa-file-excel"></i>Upload Excel</a>
        ...
        $(document).ready(function() {
            ...
            $('#search-btn').click(function(e) {
                ...
                if (session_id && class_id && category_id && group_id && exam_id) {
                    ...
                    $.get("{{route('exam-management-student-count')}}",
            ...
            $('#student-form').submit(function(e) {
                ...
                //for print button
                var reqArray = `class_id-${class_id},section_id-${section_id},category_id-${category_id},group_id-${group_id},exam_id-${exam_id},class_subject_id-${subject_id}`;
            
        
                let printRoute = "{{ route('exam-management.marks.print',100) }}"
                printRoute = printRoute.replace('100',reqArray);    
                ...
                if(!subject_id){
                    ...
                    success: function(data) {
                        ...
                        let table = `<p class="p-2">Subject: <span id="sub-name"></span></p> <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th>SL</th>
                                                <th>Student Id</th>
            ...
            function getSubjects(class_id,section_id,category_id,group_id,exam_id) {
                ...
                $.get("{{ route('exam-management.marks.get-subjects') }}", {
                        class_id,
                        section_id,
                        category_id,
                        group_id,
