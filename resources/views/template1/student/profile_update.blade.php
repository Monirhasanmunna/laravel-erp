                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="religion" class="form-select form-control">
                                                ...
                                                <option value="{{ $r->name }}" @if (isset($student))
                                                    {{ $student->religion == $r->name ? 'selected' : '' }} @endif>
                                                    {{ $r->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="gender" class="form-select form-control">
                                                ...
                                                <option value="{{ $g->name }}" @if (isset($student))
                                                    {{ $student->gender == $g->name ? 'selected' : '' }} @endif>
                                                    {{ $g->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="division_id" id="division_id">
                                                ...
                                                <option value="{{ $division->id }}"
                                                    {{$division->id == $student->division_id ? 'selected' : ''}}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="district_id" id="district_id">
                                                ...
                                                <option value="{{ $district->id }}"
                                                    {{$district->id == $student->district_id ? 'selected' : ''}}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="upazila_id" id="upazila_id">
                                                ...
                                                <option value="{{ $upazila->id }}"
                                                    {{$upazila->id == $student->upazila_id ? 'selected' : ''}}>
                            ...
                            <div class="form-row mt-2">
                                ...
                                <div class="col">
                                    ...
                                    <input type="number" class="form-control" id="father_nid"
                                        placeholder="Enter Father National Id" name="father_nid"
                                        value="{{ @$student->father_nid_no }}">
                                </div>
                                <div class="col">
                                    <label for="father_passport">Passport</label>
                                    <input type="number" class="form-control" id="father_passport"
                                        placeholder="Enter Father Passport No" name="father_passport"
                                        value="{{ @$student->father_passport_no }}">
                                </div>
                            </div>
                            ...
                            <div class="form-row mt-2">
                                ...
                                <div class="col">
                                    ...
                                    <input type="father_religion" class="form-control" id="father_religion"
                                        placeholder="Enter Father Religion" name="father_religion"
                                        value="{{ @$student->father_religion }}">
                                </div>
                                <div class="col">
                            ...
                            <div class="form-row mt-2">
                                ...
                                <div class="col">
                                    ...
                                    <input type="number" class="form-control" id="mother_nid"
                                        placeholder="Enter Mother National Id" name="mother_nid"
                                        value="{{ @$student->mother_nid_no }}">
                                </div>
                                <div class="col">
                                    <label for="mother_passport">Passport</label>
                                    <input type="number" class="form-control" id="mother_passport"
                                        placeholder="Enter Mother Passport No" name="mother_passport"
                                        value="{{ @$student->mother_passport_no }}">
                                </div>
                            </div>
                            ...
                            <div class="form-row mt-2">
                                ...
                                <div class="col">
                                    ...
                                    <input type="mother_religion" class="form-control" id="mother_religion"
                                        placeholder="Enter mother Religion" name="mother_religion"
                                        value="{{ @$student->mother_religion }}">
                                </div>
                                <div class="col">
                            ...
                            <div class="form-row mt-2">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="guardien_name"
                                        placeholder="Enter Guardien Name" name="guardien_name"
                                        value="{{ @$student->guardien_name }}">
                                </div>
                                <div class="col">
                                    <label for="guardien_nid">National Id</label>
                                    <input type="number" class="form-control" id="guardien_nid"
                                        placeholder="Enter Guardien National Id" name="guardien_nid"
                                        value="{{ @$student->guardien_nid_no }}">
                                </div>
                                <div class="col">
                                    <label for="guardien_passport">Passport</label>
                                    <input type="number" class="form-control" id="guardien_passport"
                                        placeholder="Enter Guardien Passport No" name="guardien_passport"
                                        value="{{ @$student->guardien_passport_no }}">
                                </div>
                            </div>
                            ...
                            <div class="form-row mt-2">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="guardien_nationality"
                                        placeholder="Enter Guardien Nationality" name="guardien_nationality"
                                        value="{{ @$student->guardien_nationality }}">
                                </div>
                                <div class="col">
                                    <label for="phone">Religion</label>
                                    <input type="guardien_religion" class="form-control" id="guardien_religion"
                                        placeholder="Enter Guardien Religion" name="guardien_religion"
                                        value="{{ @$student->guardien_religion }}">
                                </div>
                                <div class="col">
                                    <label for="guardien_profession">Profession</label>
                                    <input type="text" class="form-control" id="guardien_profession"
                                        placeholder="Enter Guardien Profession" name="guardien_profession"
                                        value="{{ @$student->guardien_profession }}">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row gutters m-3 p-3">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="text-right">
                    <a href="javascript:void(0)" onclick="deleteBtn()" class="btn btn-danger">Delete</a>
...
<form id="deleteForm" style="display:none;" action="{{route('student.destroy',$student->id)}}" method="post">
    @method('PUT')
    @csrf
</form>
