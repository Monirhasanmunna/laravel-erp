                            ...
                            <div>
                                ...
                                @else
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                            <a href="javascript:void(0)"  onclick="increase()" style="margin-top: 36px"
                                                class="btn btn-primary"><i class="fa fa-arrow-circle-right"></i>Proccess</a>
                                        </div>
                                    </div>
                                @endif
                            </div>
                                        ...
                                        @foreach ($uploadAdmission as $key => $ad)
                                            <tr>
                                                ...
                                                <td> <select name="religion[]" id="religion_{{ $key }}"
                                                        ...
                                                        <option value="islam"  {{$ad->religion == "Islam" ? 'selected':''}}>Islam</option>
                                                        <option value="hindu" {{@$ad->religion == "Hindu" ? 'selected':''}}>Hindu</option>
                                                        <option value="other" {{@$ad->religion == "Other" ? 'selected':''}}>Other</option>
                                                    </select>
                                                </td>
