                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('student.birthday-wish.sendMessage')}}" method="post">
                            ...
                            <table class="table table-bordered table-responsive" style="width:100%; padding:10px">
                                <thead>
                                    <tr>
                                        <th style="width:30%" class="px-2">Name</th>
                                        <th style="width:30%" class="px-2">Email</th>
                                        <th style="width:30%" class="px-2">Phone</th>
                                        <th style="width:30%" class="px-2">Date Of Birth</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @if ($students->count())
                                        @foreach ($students as $s)
                                            <tr>
                                                <td style="width:30%" class="px-2">{{$s->name}}</td>
                                                <td style="width:30%" class="px-2">{{$s->email}}</td>
                                                <td style="width:30%" class="px-2">{{$s->mobile_number}}</td>
                                                <td style="width:30%" class="px-2">{{$s->dob}}</td>
                                            </tr>
