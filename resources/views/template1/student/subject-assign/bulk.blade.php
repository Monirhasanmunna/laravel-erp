            ...
            <div class="card new-table">
                <div class="card">
                    <div class="card-header">
                        <h6 class="float-left">Bulk Subject Assign</h6>
                        <a href="{{ route('student.subject-assign.index') }}" class="btn btn-dark float-right"><i
                ...
                <div class="card d-none" id="process-card">
                    <div class="card-body">
                        <form action="{{ route('student.subject-assign.bulk-action') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="card">
                            ...
                            <button type="submit" class="btn btn-primary float-right mt-4"><i
                                    class="fa fa-save"></i>Assign</button>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#student-form').submit(function(e) {
                ...
                showSearchQuery();
                var form = $(this);
                var url = "{{ route('student.subject-assign.get-students') }}";
            ...
            function getSubjects(type_id) {
                ...
                var url = "{{ route('student.subject-assign.get-subjects') }}";
