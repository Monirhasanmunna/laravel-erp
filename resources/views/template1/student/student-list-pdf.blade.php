        ...
        <div class="mid-content">
            <div class="table-data ">
                <table style="width: 100%;">
                    <tr>
                        <th>
                            <h4 style="text-transform: capitalize !important;">ID</h4>
                            <h4 style="text-transform: capitalize !important;">Roll</h4>
                            <h4 style="text-transform: capitalize !important;">Mobile</h4>
                        </th>
                        <th>
                            <h4 style="text-transform: capitalize !important;">Student's Name</h4>
                            <h4 style="text-transform: capitalize !important;">Father's Name</h4>
                            <h4 style="text-transform: capitalize !important;">Mother's Name</h4>
                        </th>
                        <th>
                            <h4 style="text-transform: capitalize !important;">Shift</h4>
                            <h4 style="text-transform: capitalize !important;">Section</h4>
                            <h4 style="text-transform: capitalize !important;">Group</h4>
                        </th>
                        <th>
                            <h4 style="text-transform: capitalize !important;">Dob</h4>
                            <h4 style="text-transform: capitalize !important;">Gender</h4>
                            <h4 style="text-transform: capitalize !important;">Religion</h4>
                        </th>
                        
                        <th>
                            <h4 style="text-transform: capitalize !important;">Photo</h4>
                        </th>
                        <th>
                            <h4 style="text-transform: capitalize !important;">Signature</h4>
                        </th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <p>{{@$student->shift->name != 'N/A' ? @$student->shift->name : '-'}}</p>
                            <p>{{@$student->section->name != 'N/A' ? @$student->section->name : '-'}}</p>
                            <p>{{@$student->group->name != 'N/A' ? @$student->group->name : '-'}}</p>
                        </td>
                        <td style="text-align:center;">
                            <p>{{$student->dob ?? '-'}}</p>
