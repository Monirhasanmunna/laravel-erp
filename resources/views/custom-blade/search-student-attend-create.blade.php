...
<div class="row py-2" id="all-row-py-2">
    ...
    <div class="col-sm-2">
        ...
        <input type="time" value="{{date('h:i')}}" name="in_time" class="form-control" id="in_time">
    </div>

    <div class="col-sm-2 pt-2">
        <label for="">Out Time</label>
        <input type="time" value="{{date('h:i')}}" class="form-control" name="out_time" id="out_time" required>
    </div>

    <div class="col-sm-2 pt-2" id="process_btn">
