            ...
            <div class="card new-table">
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <a href="{{ route('studentleaveapplication.index') }}" class="btn btn-primary mr-2"
                            style="width: 175px;height: 34px;">Application List
                            <i class="fa fa-list"></i>
                        </a>
                    </div>
                    <div class="content-wrapper text-primary">
                        <form id="teacher-form" action="{{ !isset($application) ? route('studentleaveapplication.store') : route('studentleaveapplication.update',$application->id)}}" method="POST">
                            @csrf
                            @isset($application)
                                @method('PUT')
                            @endisset
    ...
    <script>
        $(document).ready(function() {
            $("#template_id").change(function(){
                ...
                $.ajax({
                    url     : '/student-portal/leave-application/template-details/'+temp_id,
                    type    : 'GET',
