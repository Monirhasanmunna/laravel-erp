 <nav class="sidebar sidebar-offcanvas" id="sidebar">
     ...
     <ul class="nav">
         ...
         <li class="nav-item menu-items {{Request::is('teacherpanel/exam-management*') ? 'active' : ''}}">
             <a class="nav-link" href="{{route('teacherpanel.exam-management.dashboard.index')}}">
                 <span class="menu-icon">
                     <i class="mdi mdi-speedometer"></i>
                 </span>
         ...
         <li class="nav-item menu-items {{Request::is('teacherpanel/account-management*') ? 'active':''}}">
             <a class="nav-link" href="{{route('teacherpanel.account-management.dashboard.index')}}">
                 <span class="menu-icon">
                     <i class="mdi mdi-speedometer"></i>
                 </span>
