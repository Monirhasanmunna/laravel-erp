        ...
        <div class="swiper-wrapper">
            ...
            @forelse (@$banners as $banner)
                <div class="swiper-slide">
                    <div class="img">
                        <img id="myimg" src="{{ Config::get('app.s3_url').@$banner->image }}" alt="">
                    </div>
                </div>
            @empty
                <div class="swiper-slide">
                    <div class="img">
                        <img  id="myimg" src="{{asset('assets/images/banner/demo-banner.jpg')}}" alt="">
                    </div>
                </div>
            @endforelse
        </div>
                            ...
                            <div class="col-lg-4 col-sm-4">
                                ...
                                <div class="LatestNewsLeftItem" data-aos="flip-up">
                                    ...
                                    <div class="img">
                                        ...
                                        @else
                                        <img src="{{ Config::get('app.s3_url').$item->image }}" alt="">
                                        @endif
                                    </div>

                                    <div class="text">
                                        <h3>{{ $item->title }}</h3>
                                        <p>{!! Str::limit($item->content,55)  !!}</p>
                                        <a href="{{ route('web.messages',$item->id) }}" style="color: #009900;">বিস্তারিত</a>
                                    </div>
                                </div>
                            </div>
                            @endforeach
