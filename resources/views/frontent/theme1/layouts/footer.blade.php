@php
    ...
    $seller                = App\Models\Institution::with('seller')->find(\App\Helper\Helper::getInstituteId());
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-5">
                        ...
                        <div class="FooterItem">
                            ...
                            <ul>
                                <li><a href=""><i class="fas fa-chevron-right"></i> বাংলাদেশ কারিগরি শিক্ষা বোর্ড </a>
                                </li>
                                <li><a href=""><i class="fas fa-chevron-right"></i> বাংলাদেশ মাদ্রাসা শিক্ষা বোর্ড</a>
                                </li>
                                <li><a href=""><i class="fas fa-chevron-right"></i> ঢাকা, শিক্ষা বোর্ড </a></li>
                                <li><a href=""><i class="fas fa-chevron-right"></i> চট্টগ্রাম শিক্ষা বোর্ড, </a>
                                <li>
            ...
            <div class="col-lg-4 col-sm-12">
                ...
                <div class="GetInTouch">
                    ...
                    <div class="FooterItem">
                        ...
                        <ul>
                            <li><a href="tel:+88{{@$getintouch->phone}}"><i class="fas fa-phone-alt"></i>
                                    +88{{@$getintouch->phone}}</a></li>
                            <li><a href="{{@$getintouch->email}}"><i
                                        class="fas fa-envelope"></i> {{@$getintouch->email}}</a></li>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="TinyFooter d_flex d_justify">
                    ...
                    <p>Supported By {{strtoupper($sellerName)}}</p>
                    <p>Sponsored By DIGITAL SHOP</p>
                </div>
...
@include('frontent.theme1.layouts.inc-modal.expired-modal')
@include('frontent.theme1.layouts.inc-modal.setup-modal')
