                ...
                <a href="{{Route('index')}}">
                    <div class="Logo d_flex">
                        <div class="img">
                            ...
                            @if(@$info->logo == null || @$info->logo == "default-logo.png" || @$info->logo == "logo.jpg" || @$info->logo == "logo.png")
                                <img src="{{asset('assets/images/logo/logo.png')}}" alt="">
                            @else
                                <img src="{{Config::get('app.s3_url').$info->logo}}" alt="">
                            @endif
            ...
            <div class="col-lg-7 col-sm-12">
                ...
                <div class="HeaderContent">
                    <ul>
                        ...
                        @endif
                        <li><a href="{{route('web.online_admission.index')}}" class="bg">Online Admission</a></li>
                        ...
                        <div class="img-wrapper" style="margin-top: -33px;">
                            <div class="row mb-2">
                                <div class="col-3 text-left">
                                    @if($info)
                                    <img style="max-width: 70px;" src="{{Config::get('app.s3_url').$info->logo}}" alt="">
                                    @endif
                                </div>
                            ...
                            @if($info)
                            <img class="teacher-img" style="max-width:300px" src="{{Config::get('app.s3_url').$info->logo}}" />
                            @endif
                        </div>
