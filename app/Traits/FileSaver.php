...
trait FileSaver
{
    ...
    public function uploadFileLinode($file, $model, $fieldName, $filePath)
    {
        ...
        if ($file){
            ...
            $newFileName   = 'image_'.time().'.'.$file->getClientOriginalExtension();

            $imageName = Storage::disk('linode')->put($basePath,$file);
    ...
    public function uploadFileLinodeOld($file, $model, $fieldName, $filePath)
    {
        if ($file){
