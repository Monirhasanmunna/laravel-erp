...
class CategoryController extends Controller
{
    ...
    {
        $category = Category::with('shift','section')->findOrfail($id);
    ...
    public function getSectionByShift(Request $request){
        $sections = Section::where('shift_id',$request->shiftId)->get();
