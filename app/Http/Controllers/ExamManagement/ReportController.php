...
class ReportController extends Controller
{
    ...
    public function index()
    {
        ...
        $result          = "";
        return view($this->backendTemplate['template']['path_name'].'.exammanagement.classposition.index', compact('academic_years', 'result'));
    }

    public function classPositionResult(Request $request)
    {
        $academic_years = Session::all();
       ...
       $students = Student::where('session_id', $request->academic_year_id)
        ...
        return view($this->backendTemplate['template']['path_name'].'.exammanagement.classposition.index',compact('academic_years', 'result', 'students', 'subjects', 'section', 'exam', 'grades', 'marks_dis_type'));
    }
