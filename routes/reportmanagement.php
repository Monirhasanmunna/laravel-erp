...
Route::group(['as'=>'report-management.','prefix'=>'report-management'],function(){
        ...
        Route::group(['as'=>'student-list.','prefix'=>'student-list'],function(){
            ...
            Route::any('/get-student-info/{session}',[StudentListReportController::class,'getStudentInfoBySessionId']);
            Route::any('/pdf-export/{session}',[StudentListReportController::class,'ExportPdf'])->name('ExportPdf');
        });
