...
Route::controller(SessionController::class)
    ...
    ->group(function () {
        ...
        Route::get('/set-current/{id}','setCurrent')->name('set-current');
});
...
Route::group(['as'=>'academic.','prefix'=>'/academic'],function(){
    ...
    Route::group(['as'=>'setting.','prefix'=>'/setting'],function(){
        ...
        Route::post('/update/{id}',[AcademicSettingController::class,'update'])->name('update');
    });
    ...
    Route::group(['as'=>'admit-card.','prefix'=>'/admit-card'],function(){
        ...
        Route::get('/view/{id}/{exam_id}/{session}/{isRoutineSelected}',[AdmitCardController::class,'view'])->name('view');
        Route::get('/download-admit/{id}/{exam_id}/{session}/{isRoutineSelected}',[AdmitCardController::class,'downloadCard'])->name('download');
    ...
    Route::group(['as'=>'testimonial.','prefix'=>'/testimonial'],function(){
        ...
        Route::post('/store',[TestimonialController::class,'testimonialCreate'])->name('store');
        Route::any('/update/{id}',[TestimonialController::class,'testimonialUpdate'])->name('update');
        Route::get('/print/{id}',[TestimonialController::class,'testimonialPrint'])->name('print');
