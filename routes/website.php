...
*/
    ...
    Route::group(['as'=>'web.'],function(){
        ...
        Route::group(['as'=>'online_admission.'],function(){
            Route::get('online/admission/',[WebsiteController::class,'onlineAdmission'])->name('index');
            Route::post('online/admission/store',[OnlineAdmissionController::class,'store'])->name('store');
        });


        Route::get('/web/get-sections',[StudentController::class, 'getSections'])->name('get-sections');
        Route::get('/web/get-class-shift-by-section',[StudentController::class, 'getClassShift'])->name('get-class-shift');
        Route::get('/web/getCatSecGro/{class_id}/{section_id}', [StudentController::class, 'getCatSecGro'])->name('getCatSecGro');
        Route::get('/web/get-admitted-students',[StudentController::class,'getAdmitedStudents'])->name('get-admited-students');

    });

        Route::get('/frontend/get-district/{id}',[AddressController::class,'getDistrictByDivisionId']);
        Route::get('/frontend/get-upazila/{id}',[AddressController::class,'getUpazilaByDistrictId']);
